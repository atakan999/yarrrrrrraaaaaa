...
public class GrampleItem extends MedievalInstrumentsModElements.ModElement {
	@ObjectHolder("medieval_instruments_:grample")
	public static final Item block = null;
	public GrampleItem(MedievalInstrumentsModElements instance) {
		super(instance, 20);
	}

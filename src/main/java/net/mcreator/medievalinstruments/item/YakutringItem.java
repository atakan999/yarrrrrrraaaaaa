...
public class YakutringItem extends MedievalInstrumentsModElements.ModElement {
	@ObjectHolder("medieval_instruments_:yakutring")
	public static final Item block = null;
	public YakutringItem(MedievalInstrumentsModElements instance) {
		super(instance, 12);
	}

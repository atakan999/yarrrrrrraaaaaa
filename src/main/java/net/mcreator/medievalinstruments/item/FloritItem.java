...
public class FloritItem extends MedievalInstrumentsModElements.ModElement {
	@ObjectHolder("medieval_instruments_:florit")
	public static final Item block = null;
	public FloritItem(MedievalInstrumentsModElements instance) {
		super(instance, 14);
	}
